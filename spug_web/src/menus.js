...
export default [
  ...
  {
    icon: 'cloud-server', title: '资产管理', auth: 'asset.host.view||asset.idc.view', child: [
      {title: '主机管理', auth: 'asset.host.view', path: '/asset/host'},
      {title: '机房管理', auth: 'asset.idc.view', path: '/asset/idc'},
    ]
  },
  {
